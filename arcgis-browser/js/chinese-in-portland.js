...
title.onAdd = function (map) {
    ...
    div.innerHTML += "Chinese Speaking Population 2016 and City Districts";
    return div;
};
    ...
    $.ajax({
        ...
        success: function (layer) {
            ...
            if (layer.type == 'Feature Layer') {
                ...
                // Overlay on top of language layer
                loadOverlayLayer("https://portlandmaps.com/arcgis/rest/services/Public/CGIS_Layers/MapServer/11");
            }
